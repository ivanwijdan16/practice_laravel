            ...
            <div class="col-lg-12">
                ...
                <form action="{{ route('student.update',['student' => $student->id]) }}" method="POST"
                    ...
                    <div class="form-group mb-3">
                        <label class="mb-3" for="nim">NIM</label>
                    ...
                    <div class="form-group mb-3">
                        <label class="mb-3" for="nama">Nama Lengkap</label>
                ...
                == 'P' ? 'checked': '' }}>
                    ...
                    <div class="form-group mb-3">
                        <label class="mb-3" for="jurusan">Jurusan</label>
                ...
                'Teknik Telekomunikasi'?'selected':''}}> Teknik Telekomunikasi
                    ...
                    <div class="form-group mb-3">
                        <label class="mb-3" for="alamat">Alamat</label>
                        <textarea class="form-control" id="alamat" rows="3"
                            name="alamat">{{ old('alamat') ?? $student->address}}</textarea>
                    </div>
                    <div class="form-group">
                        <label class="mb-3" for="image">Gambar Profile</label>
